...
import copy
import PrintCipher48_model_3way_i
import time
import os
...
if __name__ == "__main__":
    ...
    cd["cipher_name"] = "PrintCipher48_3way_max_round_i"
    ...
    for i in range(0, 6):
        ...
        b1[i] = 1
        bs.append(PrintCipher48_model_3way_i.perm_wire_value(copy.deepcopy(b1)))
    ...
    for ss in search_space:
        ...
        t11 = time.time()
        search_count += 1
        PrintCipher48_model_3way_i.model_build(cd, mode)
        flag = PrintCipher48_model_3way_i.solver(cd["solve_file"])
        t22 = time.time()
        print(t22 - t11)
        if flag:
            distinguish_count += 1
