...
if __name__ == "__main__":
    ...
    cd["cipher_name"] = "PrintCipher48_max_round"
    ...
    for ss in search_space:
        ...
        if flag:
            ...
            rf.write("*" * 20)
            rf.write("{} 4round impossible distinguish found\n".format(distinguish_count))
    ...
    if distinguish_find:
        tf.write("After " + str(t2 - t1) + "time, we found total {} "
                                           "4rounds impossible differential.\n\n".format(distinguish_count))
    tf.close()
