...
import copy
import PrintCipher96_model_4way
import time
import os
import random
...
if __name__ == "__main__":
    ...
    cd["cipher_name"] = "PrintCipher96_4way"
    ...
    for i in range(0, 6):
        ...
        b1[i] = 1
        bs.append(PrintCipher96_model_4way.perm_wire_value(copy.deepcopy(b1)))
    ...
    while distinguish_find:
        ...
        for ss in search_space:
            ...
            t11 = time.time()
            search_count += 1
            PrintCipher96_model_4way.model_build(cd, mode)
            flag = PrintCipher96_model_4way.solver(cd["solve_file"])
            t22 = time.time()
            print(t22 - t11)
            if flag:
