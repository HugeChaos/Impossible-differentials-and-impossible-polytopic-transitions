...
def values_propagate_phrase0(cd, round_inf):
    ...
    return begin_values, end_values, all_var, key_var, statement, middle0, middle1
...
def __mb_mode1(cd, mode):
    ...
    begin_values, end_values, all_var, key_var, statement1, middle0, middle1 = values_propagate_phrase0(cd, [mode[1][0], mode[1][1]])
